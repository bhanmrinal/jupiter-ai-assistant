...
class ChromaDBClient:
    ...
    def search_similar(self, query: str, n_results: int = None, category_filter: str = None) -> dict[str, Any]:
        ...
        try:
            ...
            if results["ids"] and results["ids"][0]:
                for i in range(len(results["ids"][0])):
                    ...
                    # Better to use: similarity = max(0, 1 - distance) or just show distance
            ...
            log.info(f"Found {formatted_results['total_found']} similar documents for query: {query[:50]}...")
