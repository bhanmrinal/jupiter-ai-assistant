...
class ScrapingPipeline:
    ...
    def _generate_stats(
        self, scraped_content: list[ScrapedContent], faq_documents: list[FAQDocument]
    ) -> dict[str, Any]:
...
def main():
    ...
    parser.add_argument(
        "--test-search", action="store_true", help="Test ChromaDB search after pipeline completion"
    )
    parser.add_argument(
        "--search-query",
        type=str,
